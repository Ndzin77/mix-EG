...
const beneficios = [
  ...
  {
    icone: Clock,
    titulo: "acelera trabalhos manuais",
    texto: "Perde muito tempo anotando e fazendo tudo manualmente? esse sistema é para você que quer economizar e ter mais tempo!",
  },
];
    ...
    >
      <div className="grid gap-4">
        <div className="rounded-2xl border-2 border-primary/30 bg-secondary/40 p-4 text-center">
          ...
          <p className="mt-0.5 break-all font-sans text-base font-bold">{email}</p>
        </div>
