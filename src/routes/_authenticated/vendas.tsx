...
function VendasPage() {
  ...
  return (
    ...
    >
      ...
      {/* Carrinho */}
      <div className="relative flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto p-5">
        {/* A marca vive no fundo da coluna inteira: continua atrás dos itens. */}
        <MarcaDagua />
        ...
        {carrinho.length === 0 ? (
          ...
          carrinho.map((item, i) => (
            <div
              ...
              className={cn(
                "rise-in relative z-10 grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 rounded-xl border border-border bg-card/70 p-3 pl-4 shadow-sm backdrop-blur-sm",
