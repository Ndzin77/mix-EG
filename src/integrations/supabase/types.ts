  ...
  public: {
    Tables: {
      cash_moves: {
        ...
        Relationships: [
          {
            foreignKeyName: "cash_moves_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      expenses: {
        Row: {
          ...
          id: string
          occurred_at: string
          origem: Database["public"]["Enums"]["payment_method"] | null
          tenant_id: string
          updated_at: string
        }
        Insert: {
    ...
    Functions: {
      kirvano: { Args: { "": Json }; Returns: Json }
    }
    Enums: {
