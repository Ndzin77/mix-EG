          ...
          {gavetaCobre && !recolhido ? (
            <>
              <button
                ...
                className="overlay-in fixed inset-0 z-30 hidden cursor-default bg-foreground/25 lg:block"
              />
              <aside
                className="gaveta-cobre fixed inset-y-0 right-0 z-40 hidden w-[26rem] flex-col border-l border-border bg-card shadow-2xl lg:flex"
