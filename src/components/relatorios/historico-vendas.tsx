...
export function HistoricoVendas({
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-border bg-card">
      ...
      {aberto ? (
        <>
          <div className="flex flex-wrap items-center gap-2 border-t border-border bg-secondary/25 px-5 py-3">
            ...
            <select
              ...
              className="h-11 rounded-xl border-2 border-border bg-card px-3 text-sm font-bold outline-none focus:border-primary"
            >
