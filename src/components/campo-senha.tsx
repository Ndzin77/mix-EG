    ...
    <label className={cn("block text-sm font-bold", className)}>
      ...
      <div className="relative mt-1">
        <input
          ...
          className={cn(
            "h-14 w-full rounded-xl border-2 bg-secondary/30 px-3 pr-12 font-sans text-lg tracking-normal tabular-nums outline-none transition-colors focus:bg-card",
            !tocado
