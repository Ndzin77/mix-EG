...
DECLARE
  p jsonb := $1;
  v_token_esperado text := 'rv@n0)-!ÇaçK1';
  v_token text;
  v_cab json;
  v_email text;
  v_evento text;
...
REVOKE ALL ON FUNCTION public.kirvano(jsonb) FROM PUBLIC, authenticated;
GRANT EXECUTE ON FUNCTION public.kirvano(jsonb) TO anon, service_role;